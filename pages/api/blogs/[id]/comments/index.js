...
// POST request logic for creating a new comment (or a reply) as an authenticated user GET request logic for getting all the comments related to a blog post
const handler = async (req, res) => {
  ...
  if (req.method === "POST") {
    ...
    try {
      ...
      // get the text that the user wants to write in the comment, and the parent comment ID if it's a reply  (note parent ID is just the ID of the coment being replied to)
